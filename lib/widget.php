	...
	function widget( $args, $instance )
	{
		...
		if ( $datasets ) {
			...
			foreach ( $datasets AS $dataset ) {
				...
				$name = ($projectmanager->hasDetails()) ? '<a href="'.$url.'"><img src="'.$projectmanager->getFileURL('thumb.'.$dataset->image).'" alt="'.stripslashes($dataset->name).'" title="'.stripslashes($dataset->name).'" /></a>' : '<img src="'.$projectmanager->getFileURL('thumb.'.$dataset->image).'" alt="'.stripslashes($dataset->name).'" title="'.stripslashes($dataset->name).'" />';
