...
<div class="wrap">
	...
	<tr valign="top">
		...
		<td>
			...
			<p><input type="checkbox" id="del_old_image" name="del_old_image" value="1" style="margin-right: 1em;" /><label for="del_old_image"><?php _e( 'Delete current image', 'projectmanager' ) ?></label></p>
			<?php endif; ?>
		</td>
	</tr>
	<?php endif; ?>
