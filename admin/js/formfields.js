ProjectManager.addFormField = function( projectId, form_field_options ) {
  time = new Date();
  ...
  new_element_contents += "<td  style='text-align: center; width: 12px; vertical-align: middle;'><a class='image_link' href='#' onclick='return ProjectManager.removeFormField(\""+new_element_id+"\");'><img src='../wp-content/plugins/projectmanager/admin/icons/trash.gif' alt='Delete' title='Delete' /></a></td>\n\r";
